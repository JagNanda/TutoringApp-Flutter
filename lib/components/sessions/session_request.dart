          ...
          children: <Widget>[
            Expanded(
              child: Container(
                ...
                height: 50.0,
                child: Center(
                  child: Text(_dateTime == null ? "Date: " : "Date: " + formattedDate.toString(),
                    style: TextStyle(
                      fontSize: 18.0,
                      color: Colors.black,
                    ),
        ...
        RaisedButton(
          ...
          onPressed: (){
            showDatePicker(
              ...
              setState((){
                _dateTime = date;
                formattedDate = _dateTime.year.toString() + "-" + _dateTime.month.toString() + "-" + _dateTime.day.toString();
              });
            });
          },
        ),
          ...
          children: <Widget>[
            Expanded(
              child: Container(
                ...
                height: 50.0,
                child: Center(
                  child: Text( calculatedCost == null ? "Cost: \$" + cost.toString() : "Cost: \$" + calculatedCost.toString(),
                    style: TextStyle(
                      fontSize: 18.0,
                      color: Colors.black,
                    ),
