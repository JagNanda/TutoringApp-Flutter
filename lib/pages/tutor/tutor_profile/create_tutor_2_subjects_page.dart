                        ...
                        children: [
                          ...
                          RaisedButton(
                            ...
                            onPressed: () {
                              ...
                              Navigator.of(context).pushNamed('/create_tutor_experience',
                                  arguments: widget.tutorProfile);
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return Card(
                              ...
                              subtitle: Text(
                                  '<#searching for this> students are interested in this '), // <-- subtitle //TODO: mark for future use
                              title: Text(
                                subjects[index],
                              ...
                              onTap: () {
                                ...
                                if (widget.tutorProfile.tutoredSubjects.isNotEmpty) {
                                  ...
                                  if (widget.tutorProfile.tutoredSubjects
                                    ...
                                    widget.tutorProfile.tutoredSubjects.remove(
                                        subjects[index]); //remove this subject from subjects
                                  } else {
                                    // The list of subjects is not empty, but does not contain this subject
                                    widget.tutorProfile.tutoredSubjects.add(
                                ...
                                for (int i = 0;
                                    i < widget.tutorProfile.tutoredSubjects.length;
                                    i++) {
                                  print(
                                      widget.tutorProfile.tutoredSubjects.elementAt(i).toString());
                                }
                              },
                              //),
                            ));
            ...
            child: RaisedButton(
              ...
              onPressed: () {
                ...
                Navigator.of(context)
                    .pushNamed('/create_tutor_skill', arguments: widget.tutorProfile);
                print("Back Pressed");
              }, // TODO: onPressed add subjects to delegate and segue to new page
            ),
            //padding: EdgeInsets.all(10),),
