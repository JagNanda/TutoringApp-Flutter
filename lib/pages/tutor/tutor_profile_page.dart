  ...
  Widget build(BuildContext context) {
    ...
    final logo = Hero(
      ...
      child: CircleAvatar(
        ...
        radius: 70.0,
        child: Image.asset('assets/logo.png',),  // TODO: insert json parsed profile image
      ),
    );

    final intro = Card(
      child: ListTile(
        title: Text('<Insert Tutor_Name>'),  // TODO: insert json parsed Name data
        subtitle: Text(  // TODO: insert json parsed 'Headline' data
    ...
    final starRating = Card(
        child: ListTile(
            title: Center(
              child: StarDisplay(
                value: 3, // TODO: insert star rating value
              ),
            ),
        )
    );
    ...
    final bio = Column(
      ...
      children: <Widget>[ // TODO: insert json parsed bio data
    ...
    final skills = Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      mainAxisSize: MainAxisSize.min,
      children: <Widget>[ // TODO: insert json parsed Skills data
        Text('Skills:'),
        Text('<Skill1>'),
        Text('<Skill2>'),
        Text('<Skill3>'),
